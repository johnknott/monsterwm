...
void grid(int hh, int cy) {
    ...
    for (client *c=head; c; c=c->next, i++) {
        ...
        XMoveResizeWindow(dis, c->win, cn*cw + USELESSGAP, cy + rn*ch/rows + USELESSGAP,
...
void monocle(int hh, int cy) {
    for (client *c=head; c; c=c->next) if (!ISFFT(c))
        XMoveResizeWindow(dis, c->win, USELESSGAP, cy + USELESSGAP, ww - 2*(BORDER_WIDTH + USELESSGAP),
...
void stack(int hh, int cy) {
    ...
    b ? XMoveResizeWindow(dis, c->win, USELESSGAP, cy + USELESSGAP, ww - 2*(BORDER_WIDTH + USELESSGAP),
                                                                    ma - 2*(BORDER_WIDTH + USELESSGAP))
      : XMoveResizeWindow(dis, c->win, USELESSGAP, cy + USELESSGAP, ma - 2*(BORDER_WIDTH + USELESSGAP),
                                                                    hh - 2*(BORDER_WIDTH + USELESSGAP));
    ...
    b ? XMoveResizeWindow(dis, c->win, cx, cy += ma, ch - USELESSGAP + d, cw)
      : XMoveResizeWindow(dis, c->win, cx, cy += USELESSGAP, cw, ch - USELESSGAP + d);
